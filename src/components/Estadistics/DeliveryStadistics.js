  ...
  return (
    <Layout title="Estadísticas">
      <Card className={style.home_item}>
        <h2>Estadísticas de entergas</h2>
        <div style={{ display: "flex",  marginLeft:"21rem" }}>
          
          <div>
            <h5>Cantidad de entregas por mes</h5>
            <BarChart
              width={500}
              height={300}
              data={data1}
...
export default DeliveryStadistics;
